...
All expose the same `POST /v1/run` endpoint described in the [OpenAPI spec](../agent-core/openapi.yaml). Any [SDK](../agent-sdks/) or [example](../agent-sdks/) works with any template.

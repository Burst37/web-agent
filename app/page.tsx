        ...
        <div className={cn(
          ...
          {!studioCollapsed && <div className="px-12 pb-16 flex flex-col gap-10 overflow-y-auto flex-1">
            ...
            <div className="grid grid-cols-2 gap-6">
              {([
                { id: "json", label: "JSON", color: "bg-heat-4 border-heat-20 hover:border-heat-40", prompt: "Use the JSON Exporter sub-agent (subagent_export_json) to format all collected data as structured JSON. Pass it a summary of everything you gathered.", icon: <svg fill="none" height="18" viewBox="0 0 24 24" width="18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M8 3H7a2 2 0 00-2 2v5a2 2 0 01-2 2 2 2 0 012 2v5a2 2 0 002 2h1M16 3h1a2 2 0 012 2v5a2 2 0 002 2 2 2 0 00-2 2v5a2 2 0 01-2 2h-1" /></svg> },
                { id: "csv", label: "CSV", color: "bg-accent-forest/[0.04] border-accent-forest/15 hover:border-accent-forest/30", prompt: "Use the CSV Exporter sub-agent (subagent_export_csv) to format all collected data as a CSV table. Pass it a summary of everything you gathered.", icon: <svg fill="none" height="18" viewBox="0 0 24 24" width="18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 6h18M3 12h18M3 18h18M9 6v12M15 6v12" /></svg> },
                { id: "markdown", label: "Report", color: "bg-accent-amethyst/[0.04] border-accent-amethyst/15 hover:border-accent-amethyst/30", prompt: "Use the Report Writer sub-agent (subagent_export_report) to format all collected data as a markdown report. Pass it a summary of everything you gathered.", icon: <svg fill="none" height="18" viewBox="0 0 24 24" width="18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6z" /><path d="M14 2v6h6M16 13H8M16 17H8M10 9H8" /></svg> },
                { id: "html", label: "HTML", color: "bg-[#fff4e6] border-[#ffe0b2] hover:border-[#ffcc80]", prompt: "Use the HTML Exporter sub-agent (subagent_export_html) to format all collected data as a styled HTML document. Pass it a summary of everything you gathered.", icon: <svg fill="none" height="18" viewBox="0 0 24 24" width="18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M16 18l6-6-6-6M8 6l-6 6 6 6" /></svg> },
                { id: "slides", label: "Slides", color: "bg-[#f3e8ff] border-[#d8b4fe] hover:border-[#c084fc]", prompt: "Use the Slide Deck Builder sub-agent (subagent_export_slides) to structure all collected data as a slide deck outline. Pass it a summary of everything you gathered.", icon: <svg fill="none" height="18" viewBox="0 0 24 24" width="18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" /><path d="M8 21h8M12 17v4" /></svg> },
                { id: "spreadsheet", label: "Spreadsheet", color: "bg-[#ecfdf5] border-[#a7f3d0] hover:border-[#6ee7b7]", prompt: "Use the Spreadsheet Builder sub-agent (subagent_export_spreadsheet) to structure all collected data as a multi-sheet spreadsheet. Pass it a summary of everything you gathered.", icon: <svg fill="none" height="18" viewBox="0 0 24 24" width="18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" /><path d="M3 9h18M3 15h18M9 3v18" /></svg> },
                { id: "pdf", label: "PDF", color: "bg-[#fef2f2] border-[#fecaca] hover:border-[#fca5a5]", prompt: "Use the PDF Document Builder sub-agent (subagent_export_pdf) to structure all collected data as a print-ready document. Pass it a summary of everything you gathered.", icon: <svg fill="none" height="18" viewBox="0 0 24 24" width="18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6z" /><path d="M14 2v6h6" /></svg> },
                { id: "document", label: "Document", color: "bg-[#eff6ff] border-[#bfdbfe] hover:border-[#93c5fd]", prompt: "Use the Document Writer sub-agent (subagent_export_document) to structure all collected data as a formal document. Pass it a summary of everything you gathered.", icon: <svg fill="none" height="18" viewBox="0 0 24 24" width="18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16v16H4zM8 8h8M8 12h8M8 16h5" /></svg> },
              ]).map((card) => {
